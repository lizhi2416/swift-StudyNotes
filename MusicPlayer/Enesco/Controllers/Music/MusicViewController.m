...
- (void)updateBufferingStatus {
    NSString *haha = [NSString stringWithFormat:@"Received %.2f/%.2f MB (%.2f %%), Speed %.2f MB/s", (double)[_streamer receivedLength] / 1024 / 1024, (double)[_streamer expectedLength] / 1024 / 1024, [_streamer bufferingRatio] * 100.0, (double)[_streamer downloadSpeed] / 1024 / 1024];
    NSLog(@"%@",haha);
...
//    NSURL *fileURL = [[NSURL alloc] initFileURLWithPath:soundFilePath];
    ...
    NSString *cachePath = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject] stringByAppendingPathComponent:@"CacheFile.mp3"];
    track.cacheFileURL = [NSURL fileURLWithPath:cachePath];
